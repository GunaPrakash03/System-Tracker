...
export class BasicInfoFormComponent extends TranslationBaseComponent implements OnInit, AfterViewInit {
	 ...
	 *
	 * When the form is creating an employee, the list is narrowed further to the
	 * three roles that mean something for a member of staff — Employee, Manager
	 * and Admin. Candidate, Viewer, Data Entry and Interviewer belong to other
	 * flows and only invite mistakes here. The Users page is unaffected: it never
	 * sets isEmployee, so it keeps the full list.
	 */
